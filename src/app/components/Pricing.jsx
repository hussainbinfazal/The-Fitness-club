      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-8">
            ...
            budget. All plans include our core facilities and expert support.
          </p>
          ...
          <div className="inline-flex items-center bg-green-100 border border-green-200 rounded-full px-6 py-3">
            ...
            <span className="text-green-800 font-medium">
              Limited Time: First Month FREE on Annual Plans!
            </span>
          </div>
        </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-gray-600 mb-4">
            All memberships include a 7-day money-back guarantee and no
            long-term contracts.
          </p>
